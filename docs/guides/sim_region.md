...
orm/缓存模型里，也有hot/cold区的概念。把数据页从磁盘中提高到RAM里，相当于从low entity变成了high entity。但不同是的是，游戏其实没有entity级别的持久化概念。high entity更新好状态以后，不需要更新回low entity。相反，game state里保存着high entity集合，模拟运算他们，其他工作就是更新high entity这个集合。
...
结束Sim
- 把sim region里的high entity保存为low entity
